# 🛒 Shopping Cart Analysis Dashboard

A Streamlit application for analyzing **shopping cart abandonment** using synthetic e‑commerce data.  
This project demonstrates data exploration, visualization, and insights into customer behavior.
...
## 🚀 Features
- Upload and analyze shopping cart datasets (`.csv`)
- Interactive charts built with **Plotly**
- Key metrics:
  - Abandonment vs completion rates
  - Average cart value by category/device
  - Device‑based shopping behavior
